...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.perf_units_key),
                mContext.getString(R.string.perf_unis_default_value));

        if (unitType.equals(mContext.getString(R.string.perf_unis_default_value))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.perf_unis_default_value))) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            int i = cursor.getColumnIndex(WeatherContract.LocationEntry._ID);
           ...
           return Long.parseLong(mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, testValues).getLastPathSegment());
        }
